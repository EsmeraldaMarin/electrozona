...
const BannerInstagram = () => {
    return (
        <div className='my-3' style={{backgroundColor:'#ddd'}}>
            <a href="https://www.instagram.com/electrozona_" target="_blank" rel="noopener noreferrer" className='d-flex p-4 justify-content-center align-items-center'>
                ...
                <div className="container text-start fw-bold ">
                    ...
                    <p className='p-0 m-0'>@electrozona_</p>
                </div>
            </a>
        </div>
    );
